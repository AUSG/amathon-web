<template>
  <div class="ausg" id="ausg">
    ...
    <div class="ausg-activities">
      <h4>Activities</h4>
      <p>
        AUSG 멤버들의 AWS 학습을 위한 교육 세션<br />
        AWS 학습의 응용을 위한 팀 별 프로젝트 진행<br />
        AWS 전파를 위한 세미나 주최<br />
        외부 대학생 대상 AWS교육<br />
        AWS와 AWSKRUG의 공식행사 서포트<br />
        AWSKRUG의 #ausg 채널 및 모임 운영<br />
        해외유저그룹 행사 및 AWS 공식행사 참여
      </p>
    </div>
